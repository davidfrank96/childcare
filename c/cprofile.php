...
// $target = "../images/".basename($image);
   ...
   $sql1 = "UPDATE children SET name = '$name', gender = '$gender', dob = '$dob'  WHERE Pid = $id AND id = $cid";
    // execute query
...
echo '<script type="text/javascript">
 ...
 echo "<script>setTimeout(\"location.href = 'cprofile.php';\",1500);</script>";
...
$sql = "SELECT * FROM children  WHERE Pid = $id";
...
$cid =   $row['id'];
 ...
 echo'<form method="POST" action="cprofile.php" id="login-form" class="login-form" autocomplete="off" role="main" enctype="multipart/form-data">
  <div>';


 echo' <center><button> Your Children\'s profile</button></center>
  </div>
  <h1 class="a11y-hidden">Update profile</h1> <br>';
     echo" <a title=".$row['name']."><img src='images/".$row['image']."' class='g' alt='My Child's pic/></a>";
  ...
  <div>
      ...
      <span class="">Scroll down to see more! <?php  echo $id ?></span>
    </label></center>
<!-- <label class="label-email">
  <input type="hidden" name="size" value="1000000">
      <input type="file" class="text" name="image"  placeholder="New Name"  tabindex="1" value="" />
      <span class="">Change Child's pic</span>
    </label> -->
    <label class="label-email">
      <input type="text" class="text" name="name"  placeholder="New Name"  tabindex="1" value="<?php echo $name; ?>" required />
      <span class="required">Name</span>
    </label>

    <label class="label-email">
      <select name="gender" >
      <option style="" value="<?php echo $gender; ?>"><?php echo $gender; ?></option>
    ...
    <label class="label-email">
      <input type="date" class="text" name="dob" placeholder=""  tabindex="1"  value="<?php echo $dob; ?>"  required />
      <span class="required">Date Of Birth</span>
    </label>

    <label class="label-email">
      <input type="hidden" class="text" name="cid"  tabindex="1"  value="<?php echo $cid; ?>"  required />
      <span class=""></span>
    </label> 
  </div>
