...
$pass =   $row['password']; 
 ...
 <form method="POST" action="pass.php" id="login-form" class="login-form" autocomplete="off" role="main">
  <div>
  ...
  <div>
    ...
    <label class="label-email">
      <input type="password" class="text" name="old_pass"  tabindex="1" id="currentPassword" required />
      <span class="required">Old Password</span>
    </label>

    <label class="label-email">
      <input type="password" class="text" name="new_pass" placeholder="Email" tabindex="1" id="newPassword" required />
      <span class="required">New Password</span>
    </label>

    <label class="label-email">
      <input type="password" class="text" name="re_pass" placeholder="Email" tabindex="1" id="confirmPassword" required />
  ...
  <br>
  <input type="submit" name="re_password" value="Change Password" />
